...
public class Utils {
    ...
    public static void start() {
        ...
        System.out.println("\n\n\n" + path + "\n\n");
        Core.instance.setMainPath(path);
    }
    ...
    public static HashMap<String, String> readFile(String pathStr) {
        ...
        if (!Files.exists(path)) {
            ...
            try {
                ...
                e.printStackTrace();
                Core.instance.getLogger().info(ChatColor.RED + "Error reading " + pathStr + "!");
            }
        }
        return map;
    }
    ...
    public static boolean saveFile(HashMap<String, String> map, String pathStr) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(new File(pathStr)));
